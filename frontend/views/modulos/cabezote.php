...
<div class="container-fluid barraSuperior" id="top">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-9 col-sm-8 col-xs-12 registro">
				...
				======================================-->
					...
					<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12" id="logotipo">
						...
						<a href="#">
							...
							<img src="http://localhost/backend/views/img/plantilla/logo.png" class="img-responsive">	
						</a>
					...
					<div class="col-lg-3 col-md-3 col-sm-2 col-sx-12" id="carrito">
						...
						<p>TU CESTA <span class="cantidadCesta"></span> <br>EUR $ <span class="sumaCesta"></span></p>
